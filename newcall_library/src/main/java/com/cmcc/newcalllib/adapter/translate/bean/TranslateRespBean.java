...
public class TranslateRespBean implements java.io.Serializable {

    private String innerUrl;
    private String msgId;
    private TranslateRespBodyBean body;
    ...
    public TranslateRespBodyBean getBody() {
        return body;
    }

    public void setBody(TranslateRespBodyBean body) {
        this.body = body;
    }
